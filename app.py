...
if st.session_state.mode == "chat":
    if user_prompt:
        ...
        general_llm = ChatOpenAI(model="gpt-4", temperature=0.7, api_key=os.environ["OPENAI_API_KEY"],
                                 max_tokens=1500)
        ...
        def respond_to_user():
            if st.session_state.df is not None:
                ...
                llm = ChatOpenAI(model="gpt-4", temperature=0, api_key=os.environ["OPENAI_API_KEY"], max_tokens=1500)
